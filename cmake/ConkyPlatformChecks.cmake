...
if(BUILD_I18N AND OS_DRAGONFLY)
    set(conky_includes ${conky_includes} /usr/local/include/gettext)
...
if(MAINTAINER_MODE)
	...
	mark_as_advanced(APP_DB2X_XSLTPROC APP_DB2X_MANXML APP_XSLTPROC APP_MAN APP_LESS)
endif(MAINTAINER_MODE)

find_program(APP_SED sed)
if(APP_SED)
	execute_process(COMMAND "sed --version" OUTPUT_QUIET ERROR_QUIET RESULT_VARIABLE SED_RC)
	if(SED_RC)
		find_program(APP_GSED gsed)
		if (NOT APP_GSED)
			message(FATAL_ERROR "No GNU sed found, please install")
		endif(NOT APP_GSED)
	endif(SED_RC)
else(APP_SED)
